...
it around March 1996, in C (a language I was far more familiar with at a low level, having spent many
years writing in it, and also various assembly languages).

This version 2 was more successful - both in terms of performance, and also personally for my final year project.
...
got a compute grid... "just like that"....
...
ports, if configured. Link 0 can also communicate with a server process. I defined a small protocol for this server
...
# Origin - Phase 4, Trains and Parallel Processing and Modern Operating Systems
...
# Future
Once eForth works, there will need to be an ELF loader, and a bootloader that can link with an ELF object. Then a
